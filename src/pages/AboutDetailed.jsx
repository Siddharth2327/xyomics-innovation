         ...
         {[
            {
              ...
              description:
                "A pioneer in clinical diagnostics, Dr. Bhavanisree brings unmatched expertise in biochemistry and serology. As former HOD of Serology at Hitech Diagnostic Centre, she specialized in infectious disease testing, immunofluorescence, and newborn screening.",
            },
            {
              name: "Mr. Nandhakumar",
            ...
            {
              name: "Mr. Avinash Shanmugasundaram",
              ...
              description:
                "With an M.Sc. in Medical Biochemistry, Mr. Avinash bridges research and client engagement through quality assurance and operational strategy.",
            },
          ].map((person, index) => (
            <motion.div
              key={index}
        ...
        >
          ...
          {[
            ...
            <motion.div
              ...
              animate={isInView ? { opacity: 1, x: 0 } : {}}
              transition={{ delay: 0.3 * index, duration: 0.6 }}
              className="border-l-4 border-[#861FD2] pl-6"
            >
